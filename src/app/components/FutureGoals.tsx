      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-10">
          ...
          <Animated animation="fade-right">
            <div className="glass glass-card-hover p-8 relative overflow-hidden h-full">
          ...
          <Animated animation="fade-left">
            <div className="relative overflow-hidden rounded-2xl" style={{
              ...
              <div className="relative z-10 p-8 h-full flex flex-col justify-end">
                ...
                <p style={{ color: 'rgba(200,220,255,0.85)', lineHeight: 1.7 }}>
        ...
        <Animated animation="zoom-in" delay={100}>
          <div className="glass-strong p-8 mb-10">
            <div className="flex flex-col md:flex-row items-center gap-6">
              <Animated animation="fade-right" delay={200} className="w-full md:w-1/3">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-3 gap-4 mt-6">
                  {[
                    ...
                    <Animated key={text} animation="zoom-in" delay={(i * 100) as 0 | 100 | 200}>
