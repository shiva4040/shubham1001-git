...
export function Games() {
  ...
  const GameCard = ({ game }: { game: { name: string; emoji: string; description: string } }) => (
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {androidGames.map((game, i) => <GameCard key={i} game={game} />)}
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {physicalGames.map((game, i) => <GameCard key={i} game={game} />)}
            </div>
          </div>
        </div>
