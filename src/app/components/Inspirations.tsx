...
export function Inspirations() {
    return (
        <section id="inspirations" className="py-24 px-4">
            <div className="max-w-6xl mx-auto">
                <Animated animation="fade-up">
                    <h2 className="text-4xl md:text-5xl text-center mb-4 text-glow-warm font-bold">My Heroes &amp; Inspirations</h2>
                </Animated>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-14">
                    {heroes.map(({ name, emoji, role, why, quote, color, glow, gradient }, i) => (
                        <Animated key={name} animation={i % 2 === 0 ? 'fade-right' : 'fade-left'} delay={(i * 100) as 0 | 100 | 200 | 300}>
                            <div
                                className="glass glass-card-hover p-7 rounded-2xl h-full relative overflow-hidden"
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold" style={{ color: 'var(--text-heading)' }}>{name}</h3>
                                        <p className="text-xs font-medium tracking-wide" style={{ color }}>{role}</p>
                                    </div>
                                    <Star className="w-5 h-5 ml-auto flex-shrink-0" style={{ color: '#fbbf24' }} />
                                </div>

                                <p className="text-sm mb-5" style={{ color: 'var(--text-body)', lineHeight: 1.75 }}>{why}</p>

                                <div className="rounded-xl p-4" style={{ background: 'var(--glass-bg)', border: `1px solid ${color}25` }}>
                                    <Quote className="w-4 h-4 mb-2" style={{ color }} />
                ...
                <Animated animation="zoom-in" delay={200}>
                    <div className="glass-strong p-8 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="max-w-2xl mx-auto" style={{ color: 'var(--text-body)', lineHeight: 1.8 }}>
